package com.gdme.s07150737.alertdialog;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void dialog1(){
        ...
        DialogInterface.OnClickListener lisl=new DialogInterface.OnClickListener() {
            @Override
        ...
        ad.setButton(DialogInterface.BUTTON_POSITIVE,"退出",lisl);
        ad.setButton(DialogInterface.BUTTON_NEGATIVE,"取消",lisl);
        ad.show();
    }
    private void dialog2(){
        ...
        ad.setButton(DialogInterface.BUTTON_NEUTRAL,"非常轻松",lis2);
        ad.show();
    }
